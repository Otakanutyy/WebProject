...
from .views import (
    ...
    ProductsByCategoryView,  add_to_wishlist, product_pictures_by_product_id, remove_from_wishlist, remove_order, top_rated_products,
    wishlist_by_user_id, orders_by_user_id, comments_by_product_id, UserList, UserDetail)
...
urlpatterns = [
    ...
    path('orders/<int:user_id>/', orders_by_user_id, name='orders-by-user'),
    ...
    path('orders/<int:user_id>/remove/<int:order_id>/', remove_order, name='remove-order'),
    path('product-pictures/<int:product_id>/', product_pictures_by_product_id, name='product-pictures-by-product-id'),
]
